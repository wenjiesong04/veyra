...
ALLOWED_ENV_KEYS = {
    ...
    "VEYRA_PHASE6_TRUSTED_RUNNER_ENABLED",
    "VEYRA_ISOLATED_RUNNER_DOCKER_BINARY",
    "VEYRA_ISOLATED_RUNNER_DOCKER_CONTEXT",
    ...
    "VEYRA_ISOLATED_RUNNER_CONFORMANCE_CERTIFIED",
    "VEYRA_EXTENSION_GENERATION_ENABLED",
    "VEYRA_PHASE6_DYNAMIC_VALIDATION_ENABLED",
    "VEYRA_PHASE6_DYNAMIC_VALIDATION_CONFORMANCE_DIGEST",
    "VEYRA_PHASE6_DYNAMIC_VALIDATION_CONFORMANCE_CERTIFIED",
    "VEYRA_PHASE6_EXTENSION_RELEASE_ENABLED",
    "VEYRA_PHASE6_RELEASE_PRIVATE_KEY_PATH",
    "VEYRA_PHASE6_RELEASE_PUBLIC_KEY_B64",
    "VEYRA_PHASE6_RELEASE_SIGNING_SERVICE_ID",
    "VEYRA_PHASE6_INVOCATION_CONFORMANCE_DIGEST",
    "VEYRA_PHASE6_INVOCATION_CONFORMANCE_CERTIFIED",
    "VEYRA_PHASE6_EXTENSION_DEPLOYMENT_MODE",
    "VEYRA_PHASE6_EXTENSION_PIPELINE_ENABLED",
    "VEYRA_PHASE6_EXTENSION_APPROVER_TOKEN",
    "VEYRA_GITHUB_TOKEN",
...
VEYRA_ISOLATED_RUNNER_DOCKER_BINARY=
VEYRA_ISOLATED_RUNNER_DOCKER_CONTEXT=colima-veyra-runner
VEYRA_ISOLATED_RUNNER_EXPECTED_IMAGE_ID=
VEYRA_ISOLATED_RUNNER_EXPECTED_ENGINE_DIGEST=
VEYRA_ISOLATED_RUNNER_CONFORMANCE_DIGEST=
VEYRA_ISOLATED_RUNNER_CONFORMANCE_CERTIFIED=0
VEYRA_EXTENSION_GENERATION_ENABLED=0
VEYRA_PHASE6_DYNAMIC_VALIDATION_ENABLED=0
VEYRA_PHASE6_DYNAMIC_VALIDATION_CONFORMANCE_DIGEST=
VEYRA_PHASE6_DYNAMIC_VALIDATION_CONFORMANCE_CERTIFIED=0
VEYRA_PHASE6_EXTENSION_RELEASE_ENABLED=0
VEYRA_PHASE6_RELEASE_PRIVATE_KEY_PATH=
VEYRA_PHASE6_RELEASE_PUBLIC_KEY_B64=
VEYRA_PHASE6_RELEASE_SIGNING_SERVICE_ID=veyra.release.signer.local.v1
VEYRA_PHASE6_INVOCATION_CONFORMANCE_DIGEST=
VEYRA_PHASE6_INVOCATION_CONFORMANCE_CERTIFIED=0
VEYRA_PHASE6_EXTENSION_DEPLOYMENT_MODE=record_only
VEYRA_PHASE6_EXTENSION_PIPELINE_ENABLED=0
VEYRA_PHASE6_EXTENSION_APPROVER_TOKEN=
VEYRA_GITHUB_TOKEN=
