...
ARCHITECTURE_BLOCKS: list[dict[str, Any]] = [
    {
        "id": "core",
        "name": "Veyra Core",
        "role": "Awareness, state, attention, decision, risk governance, verification, and patch generation.",
...
CORE_MODULES: list[dict[str, str]] = [
    ...
    {"id": "agency_core", "path": "core/agency_core.py", "status": "placeholder"},
    {"id": "perception_layer", "path": "core/perception_layer.py", "status": "mvp_foundation"},
...
IMPLEMENTATION_PHASES: list[dict[str, str]] = [
    ...
    {"phase": "P6", "name": "End-to-end runtime hardening", "status": "in_progress"},
    {"phase": "P7", "name": "Production operations and safety validation", "status": "started"},
]
