...
STATE_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "owner": "Runtime.SemanticSituationRuntime + Core.SituationStateRepository + Core.SituationEvaluator (legacy event writer)",
        "purpose": "The single owner-scoped semantic and event-bound Situation document; repository validation, CAS, and terminal-first retention protect its identity across semantic and legacy writes.",
        "freshness": "event_and_revision_backed",
    },
    {
        "id": "situation_admission_ledger",
        "file": "state/runtime/situation_admission_ledger.json",
        "owner": "Runtime.LivingContextAdmissionLedger",
        "purpose": "Bounded prepared/repair/committed event bindings across Situation and InformationNeed writes; not a second Situation truth.",
        "freshness": "event_digest_and_retention_backed",
    },
    {
        "id": "information_need_state",
        "file": "state/runtime/information_need_state.json",
        "owner": "Runtime.InformationNeedRuntime",
        "purpose": "Owner-scoped bounded InformationNeed lifecycle linked to authoritative semantic Situations; it requests observation but never grants source or execution authority.",
        "freshness": "revision_backed",
    },
    {
        "id": "living_reaction_state",
        "file": "state/runtime/living_reaction_state.json",
        "owner": "Runtime.LivingReactionRuntime",
        "purpose": "Owner/session-scoped hot ask/read/wait/silent/suggest ledger and bounded feedback aftereffects; no delivery or execution authority.",
        "freshness": "revision_backed",
    },
    {
        "id": "living_reaction_archive",
        "file": "state/runtime/living_reaction_archive.json + state/runtime/living_reaction_archive/segment_<sha>.json",
        "owner": "Runtime.LivingReactionArchive",
        "purpose": "Immutable content-addressed archive segments for exact reaction, feedback, and policy replay after hot-state compaction; the manifest chain fails closed on tamper or scope mismatch.",
        "freshness": "content_digest_and_chain_backed",
    },
    {
        "id": "living_source_state",
        "file": "state/runtime/living_source_state.json",
        "owner": "Runtime.LivingSourceRuntime",
        "purpose": "Server-issued source bindings, explicit consent, read-only requests, and typed receipts; no arbitrary query, path, tool, or authority input.",
        "freshness": "receipt_and_consent_backed",
    },
    {
