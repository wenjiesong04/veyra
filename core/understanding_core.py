...
TURN_UNDERSTANDING_SYSTEM = (
    ...
    "decision, not a keyword or source-name heuristic. When multiple independent Needs correspond to items "
    "in candidate.unknown, each Need must set unknown_index to the exact zero-based unknown[] position; use "
    "each index at most once and omit it for the ordinary single-Need/single-Unknown shape. "
