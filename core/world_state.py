...
STATE_FILE_LAYOUT: dict[str, str] = {
    ...
    "trusted_workspace_observer_state.json": f"{STATE_RUNTIME}/trusted_workspace_observer_state.json",
    ...
    "situation_admission_ledger.json": f"{STATE_RUNTIME}/situation_admission_ledger.json",
    "information_need_state.json": f"{STATE_RUNTIME}/information_need_state.json",
    "living_reaction_state.json": f"{STATE_RUNTIME}/living_reaction_state.json",
    "living_reaction_archive.json": f"{STATE_RUNTIME}/living_reaction_archive.json",
    "living_source_state.json": f"{STATE_RUNTIME}/living_source_state.json",
    ...
    "product_conversation_state.json": f"{STATE_RUNTIME}/product_conversation_state.json",
...
STATE_METADATA: dict[str, dict[str, Any]] = {
    ...
    "trusted_workspace_observer_state.json": {"source": "trusted_workspace_observer", "ttl_seconds": 0, "confidence": 1.0},
    ...
    "situation_state.json": {"source": "semantic_situation_repository", "ttl_seconds": 0, "confidence": 0.78},
    "situation_admission_ledger.json": {"source": "living_context_admission", "ttl_seconds": 0, "confidence": 1.0},
    "information_need_state.json": {"source": "information_need_runtime", "ttl_seconds": 0, "confidence": 1.0},
    "living_reaction_state.json": {"source": "living_reaction_runtime", "ttl_seconds": 0, "confidence": 1.0},
    "living_reaction_archive.json": {"source": "living_reaction_archive", "ttl_seconds": 0, "confidence": 1.0},
    "living_source_state.json": {"source": "living_source_runtime", "ttl_seconds": 0, "confidence": 1.0},
    ...
    "product_conversation_state.json": {"source": "product_conversation_runtime", "ttl_seconds": 0, "confidence": 1.0},
...
class WorldStateStore:
        ...
        defaults: dict[str, Any] = {
            ...
            "living_reaction_state.json": {
                ...
                "metrics": {
                    "reaction_count": 0,
                    "feedback_count": 0,
                    "disposition_counts": {"ask": 0, "read": 0, "wait": 0, "silent": 0, "suggest": 0},
                },
                "authority": {
                    "execution": False,
            ...
            "living_reaction_archive.json": {
                "schema_version": "veyra.living_reaction_archive.v1",
                "segments": [],
                "head_digest": "",
                "authority": {
                    "execution": False,
            ...
            "living_source_state.json": {
                "schema_version": "veyra.living_source.runtime.v1",
                "bindings": {},
                "consents": {},
                "requests": {},
                "receipts": {},
            ...
            "product_conversation_state.json": {
                "schema_version": "veyra.product_conversation_state.v1",
                "conversations": {},
                "binding_index": {},
                "message_index": {},
                "reaction_index": {},
    ...
    def read_all(self) -> dict[str, Any]:
        return {
            ...
            "situation_admission_ledger": self.read_json("situation_admission_ledger.json"),
            "information_need_state": self.read_json("information_need_state.json"),
            "living_reaction_state": self.read_json("living_reaction_state.json"),
            "living_reaction_archive": self.read_json("living_reaction_archive.json"),
            "living_source_state": self.read_json("living_source_state.json"),
