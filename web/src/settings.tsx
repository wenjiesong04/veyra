...
export function Settings({ theme, language, scope, onTheme, onLanguage, onOpenSetup }: { theme: Theme; language: Language; scope: OwnerScope; onTheme: (value: Theme) => void; onLanguage: (value: Language) => void; onOpenSetup: () => void }) {
