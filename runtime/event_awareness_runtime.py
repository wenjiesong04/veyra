...
class ShadowAwarenessRuntime:
    ...
    def derive_attention_lifecycle_from_event(
        ...
        *,
        ...
        """Reject lifecycle mutations until a trusted domain producer exists.

        EventInbox and structured-observation records are evidence, not
        lifecycle commands.  Keeping this boundary explicit avoids carrying
        an unreachable pseudo-implementation behind a fail-closed return.
        """

        del target_hypothesis_id, user_id, session_id
        selected_event_id = (
